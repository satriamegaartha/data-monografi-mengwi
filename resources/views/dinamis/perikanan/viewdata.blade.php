                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                                ...
                                <fieldset disabled="disabled">
                                    ...
                                    <div class="form-group row {{$errors->has('bandeng_luas') ? 'has-error' : ''}} ">
                                        <div class="col-sm-6">
                                            ...
                                            <input name="bandeng_luas" type="text" class="form-control"
                                                id="bandeng_luas" aria-describedby=""
                                                value="{{$perikanan->bandeng_luas}}">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input name="bandeng_hasil" type="text" class="form-control"
                                                id="bandeng_hasil" aria-describedby=""
                                                value="{{$perikanan->bandeng_hasil}}">
                                    ...
                                    <div class="form-group row {{$errors->has('kurakura_luas') ? 'has-error' : ''}} ">
                                        <div class="col-sm-6">
                                            ...
                                            <input name="kurakura_luas" type="text" class="form-control"
                                                id="kurakura_luas" aria-describedby=""
                                                value="{{$perikanan->kurakura_luas}}">
                                    ...
                                    <div class="form-group row {{$errors->has('lainnya_luas') ? 'has-error' : ''}} ">
                                        <div class="col-sm-6">
                                            ...
                                            <input name="lainnya_luas" type="text" class="form-control"
                                                id="lainnya_luas" aria-describedby=""
                                                value="{{$perikanan->lainnya_luas}}">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input name="lainnya_hasil" type="text" class="form-control"
                                                id="lainnya_hasil" aria-describedby=""
                                                value="{{$perikanan->lainnya_hasil}}">
                            ...
                            <a href="/dinamis/perikanan/{{$perikanan->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                        </div>
                    </div>
