                            ...
                            <form method="POST" action="/dinamis/keagrariaan/create">
                                ...
                                <div class="form-group {{$errors->has('tm_sertifikat') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tm_sertifikat" type="text" class="form-control" id="tm_sertifikat"
                                        aria-describedby="" placeholder="M" value="{{old('tm_sertifikat')}}">
                                ...
                                <div class="form-group {{$errors->has('tanah_hak_pengelolaan') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tanah_hak_pengelolaan" type="text" class="form-control"
                                        ...
                                        value="{{old('tanah_hak_pengelolaan')}}">
                                ...
                                <div class="form-group {{$errors->has('tanah_negara') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tanah_negara" type="text" class="form-control" id="tanah_negara"
                                        aria-describedby="" placeholder="M" value="{{old('tanah_negara')}}">
                                ...
                                <div class="form-group {{$errors->has('tanah_bebas') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tanah_bebas" type="text" class="form-control" id="tanah_bebas"
                                        aria-describedby="" placeholder="M" value="{{old('tanah_bebas')}}">
                                ...
                                <div class="form-group {{$errors->has('tanah_hak_pakai') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tanah_hak_pakai" type="text" class="form-control" id="tanah_hak_pakai"
                                        aria-describedby="" placeholder="M" value="{{old('tanah_hak_pakai')}}">
                                ...
                                <div class="form-group {{$errors->has('tanah_hak_guna_bangunan') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tanah_hak_guna_bangunan" type="text" class="form-control"
                                        ...
                                        value="{{old('tanah_hak_guna_bangunan')}}">
                                ...
                                <div class="form-group {{$errors->has('tanah_hak_guna_usaha') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tanah_hak_guna_usaha" type="text" class="form-control"
                                        ...
                                        value="{{old('tanah_hak_guna_usaha')}}">
                                ...
                                <div class="form-group {{$errors->has('tanah_adat') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tanah_adat" type="text" class="form-control" id="tanah_adat"
                                        aria-describedby="" placeholder="M" value="{{old('tanah_adat')}}">
                                ...
                                <div class="form-group {{$errors->has('sawah_perumahan') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="sawah_perumahan" type="text" class="form-control" id="sawah_perumahan"
                                        aria-describedby="" placeholder="M" value="{{old('sawah_perumahan')}}">
                                ...
                                <div class="form-group {{$errors->has('sawah_industri') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="sawah_industri" type="text" class="form-control" id="sawah_industri"
                                        aria-describedby="" placeholder="M" value="{{old('sawah_industri')}}">
                                ...
                                <div class="form-group {{$errors->has('sawah_jasa') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="sawah_jasa" type="text" class="form-control" id="sawah_jasa"
                                        aria-describedby="" placeholder="M" value="{{old('sawah_jasa')}}">
                                ...
                                <div class="form-group {{$errors->has('sawah_perusahaan_dll') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="sawah_perusahaan_dll" type="text" class="form-control"
                                        ...
                                        value="{{old('sawah_perusahaan_dll')}}">
                                ...
                                <div class="form-group {{$errors->has('tegalan_jasa') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tegalan_jasa" type="text" class="form-control" id="tegalan_jasa"
                                        aria-describedby="" placeholder="M" value="{{old('tegalan_jasa')}}">
                                ...
                                <div class="form-group {{$errors->has('tegalan_perusahaan_dll') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tegalan_perusahaan_dll" type="text" class="form-control"
                                        ...
                                        value="{{old('tegalan_perusahaan_dll')}}">
                                ...
                                <div class="form-group {{$errors->has('perkebunan_perumahan') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="perkebunan_perumahan" type="text" class="form-control"
                                        ...
                                        value="{{old('perkebunan_perumahan')}}">
                                ...
                                <div class="form-group {{$errors->has('perkebunan_jasa') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="perkebunan_jasa" type="text" class="form-control" id="perkebunan_jasa"
                                        aria-describedby="" placeholder="M" value="{{old('perkebunan_jasa')}}">
                                ...
                                <div
                                    ...
                                    <input name="perkebunan_perusahaan_dll" type="text" class="form-control"
                                        ...
                                        value="{{old('perkebunan_perusahaan_dll')}}">
                                ...
                                <div class="form-group {{$errors->has('hutan_perumahan') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="hutan_perumahan" type="text" class="form-control" id="hutan_perumahan"
                                        aria-describedby="" placeholder="M" value="{{old('hutan_perumahan')}}">
                                ...
                                <div class="form-group {{$errors->has('hutan_industri') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="hutan_industri" type="text" class="form-control" id="hutan_industri"
                                        aria-describedby="" placeholder="M" value="{{old('hutan_industri')}}">
                                ...
                                <div class="form-group {{$errors->has('hutan_jasa') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="hutan_jasa" type="text" class="form-control" id="hutan_jasa"
                                        aria-describedby="" placeholder="M" value="{{old('hutan_jasa')}}">
                                ...
                                <div class="form-group {{$errors->has('hutan_perusahaan_dll') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="hutan_perusahaan_dll" type="text" class="form-control"
                                        ...
                                        value="{{old('hutan_perusahaan_dll')}}">
                                ...
                                <div class="form-group {{$errors->has('tambak_industri') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tambak_industri" type="text" class="form-control" id="tambak_industri"
                                        aria-describedby="" placeholder="M" value="{{old('tambak_industri')}}">
                                ...
                                <div class="form-group {{$errors->has('tambak_jasa') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tambak_jasa" type="text" class="form-control" id="tambak_jasa"
                                        aria-describedby="" placeholder="M" value="{{old('tambak_jasa')}}">
                                ...
                                <div class="form-group {{$errors->has('tambak_perusahaan_dll') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tambak_perusahaan_dll" type="text" class="form-control"
                                        ...
                                        value="{{old('tambak_perusahaan_dll')}}">
