                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" action="/dinamis/pangan/{{$pangan->id}}/update">
                                <fieldset disabled="disabled">
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group {{$errors->has('tanggal') ? 'has-error' : ''}} ">
                                                ...
                                                <input name="tanggal" type="date" class="form-control" id="tanggal"
                                                    aria-describedby="" placeholder="" value="{{$pangan->tanggal}}">
                                    ...
                                    <div
                                        class="form-group {{$errors->has('luas_bimas_padi_insus') ? 'has-error' : ''}} ">
                                    ...
                                    <div
                                        ...
                                        <input name="luas_padi_intensifikasi" type="text" class="form-control"
                                            ...
                                            value="{{$pangan->luas_padi_intensifikasi}}">
                                    ...
                                    <div class="form-group {{$errors->has('luas_hama_tikus') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="luas_hama_tikus" type="text" class="form-control"
                                            id="luas_hama_tikus" aria-describedby="" placeholder=""
                                            value="{{$pangan->luas_hama_tikus}}">
                                    ...
                                    <div class="form-group {{$errors->has('luas_hama_lainnya') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="luas_hama_lainnya" type="text" class="form-control"
                                            ...
                                            value="{{$pangan->luas_hama_lainnya}}">
                                    ...
                                    <div class="form-group {{$errors->has('luas_puso_tikus') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="luas_puso_tikus" type="text" class="form-control"
                                            id="luas_puso_tikus" aria-describedby="" placeholder=""
                                            value="{{$pangan->luas_puso_tikus}}">
                                    ...
                                    <div class="form-group {{$errors->has('luas_puso_banjir') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="luas_puso_banjir" type="text" class="form-control"
                                            ...
                                            value="{{$pangan->luas_puso_banjir}}">
                                        @if ($errors->has('luas_puso_banjir'))
                                        <span class="help-block">{{$errors->first('luas_puso_banjir')}}</span>
                                        @endif
                                    </div>
                                    <div
                                        class="form-group {{$errors->has('luas_puso_kekeringan') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="luas_puso_kekeringan" type="text" class="form-control"
                                            ...
                                            value="{{$pangan->luas_puso_kekeringan}}">
                                    ...
                                    <div class="form-group {{$errors->has('penyalur_urea') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="penyalur_urea" type="text" class="form-control" id="penyalur_urea"
                                            aria-describedby="" placeholder="" value="{{$pangan->penyalur_urea}}">
                                    ...
                                    <div class="form-group {{$errors->has('penyalur_tps') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="penyalur_tps" type="text" class="form-control" id="penyalur_tps"
                                            aria-describedby="" placeholder="" value="{{$pangan->penyalur_tps}}">
                                        @if ($errors->has('penyalur_tps'))
                                        <span class="help-block">{{$errors->first('penyalur_tps')}}</span>
                                        @endif
                                    </div>
                                    <div
                                        class="form-group {{$errors->has('penyalur_insektisida') ? 'has-error' : ''}} ">
                                    ...
                                    <div
                                        ...
                                        <input name="penyalur_rodentisida" type="text" class="form-control"
                                            ...
                                            value="{{$pangan->penyalur_rodentisida}}">
                            ...
                            <a href="/dinamis/pangan/{{$pangan->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                        </div>
                    </div>
