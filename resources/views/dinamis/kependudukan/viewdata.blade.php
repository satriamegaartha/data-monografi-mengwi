                            ...
                            <form method="POST" action="#">
                                <fieldset disabled="disabled">
                                    ...
                                    <div class="form-group {{$errors->has('kepadatan') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kepadatan" type="text" class="form-control" id="kepadatan"
                                            aria-describedby="" placeholder="per Km2"
                                            value="{{$kependudukan->kepadatan}}">
                                    ...
                                    <div class="form-group {{$errors->has('petani_pemilik') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="petani_pemilik" type="text" class="form-control"
                                            id="petani_pemilik" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->petani_pemilik}}">
                                    ...
                                    <div class="form-group {{$errors->has('petani_penggarap') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="petani_penggarap" type="text" class="form-control"
                                            id="petani_penggarap" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->petani_penggarap}}">
                                    ...
                                    <div class="form-group {{$errors->has('petani_penyekap') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="petani_penyekap" type="text" class="form-control"
                                            id="petani_penyekap" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->petani_penyekap}}">
                                    ...
                                    <div class="form-group {{$errors->has('nelayan') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="nelayan" type="text" class="form-control" id="nelayan"
                                            aria-describedby="" placeholder="" value="{{$kependudukan->nelayan}}">
                                    ...
                                    <div class="form-group {{$errors->has('pengusaha_sedang') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="pengusaha_sedang" type="text" class="form-control"
                                            id="pengusaha_sedang" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->pengusaha_sedang}}">
                                    ...
                                    <div class="form-group {{$errors->has('pengrajin') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="pengrajin" type="text" class="form-control" id="pengrajin"
                                            aria-describedby="" placeholder="" value="{{$kependudukan->pengrajin}}">
                                    ...
                                    <div class="form-group {{$errors->has('buruh_industri') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="buruh_industri" type="text" class="form-control"
                                            id="buruh_industri" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->buruh_industri}}">
                                    ...
                                    <div class="form-group {{$errors->has('buruh_bangunan') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="buruh_bangunan" type="text" class="form-control"
                                            id="buruh_bangunan" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->buruh_bangunan}}">
                                    ...
                                    <div class="form-group {{$errors->has('buruh_pertambangan') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="buruh_pertambangan" type="text" class="form-control"
                                            id="buruh_pertambangan" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->buruh_pertambangan}}">
                                    ...
                                    <div class="form-group {{$errors->has('buruh_perkebunan') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="buruh_perkebunan" type="text" class="form-control"
                                            id="buruh_perkebunan" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->buruh_perkebunan}}">
                                    ...
                                    <div class="form-group {{$errors->has('pedagang') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="pedagang" type="text" class="form-control" id="pedagang"
                                            aria-describedby="" placeholder="" value="{{$kependudukan->pedagang}}">
                                    ...
                                    <div class="form-group {{$errors->has('abri') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="abri" type="text" class="form-control" id="abri"
                                            aria-describedby="" placeholder="" value="{{$kependudukan->abri}}">
                                        @if ($errors->has('abri'))
                                    ...
                                    <div class="form-group {{$errors->has('pensiun') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="pensiun" type="text" class="form-control" id="pensiun"
                                            aria-describedby="" placeholder="" value="{{$kependudukan->pensiun}}">
                                    ...
                                    <div class="form-group {{$errors->has('peternak_sapi_perah') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="peternak_sapi_perah" type="text" class="form-control"
                                            id="peternak_sapi_perah" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->peternak_sapi_perah}}">
                                    ...
                                    <div class="form-group {{$errors->has('peternak_sapi_biasa') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="peternak_sapi_biasa" type="text" class="form-control"
                                            id="peternak_sapi_biasa" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->peternak_sapi_biasa}}">
                                    ...
                                    <div class="form-group {{$errors->has('peternak_kerbau') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="peternak_kerbau" type="text" class="form-control"
                                            id="peternak_kerbau" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->peternak_kerbau}}">
                                    ...
                                    <div class="form-group {{$errors->has('peternak_kambing') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="peternak_kambing" type="text" class="form-control"
                                            id="peternak_kambing" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->peternak_kambing}}">
                                    ...
                                    <div class="form-group {{$errors->has('peternak_domba') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="peternak_domba" type="text" class="form-control"
                                            id="peternak_domba" aria-describedby="" placeholder=""
                                            value="{{$kependudukan->peternak_domba}}">
                                    ...
                                    <div class="form-group {{$errors->has('lain') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="lain" type="text" class="form-control" id="lain"
                                            aria-describedby="" placeholder="" value="{{$kependudukan->lain}}">
                                        @if ($errors->has('lain'))
