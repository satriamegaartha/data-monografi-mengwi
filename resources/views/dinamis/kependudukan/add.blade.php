                    ...
                    <div class="panel">
                            ...
                            <form method="POST" action="/dinamis/kependudukan/create">
                                ...
                                <div class="form-group {{$errors->has('jml_laki') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_laki" type="text" class="form-control" id="jml_laki"
                                        aria-describedby="" placeholder="" value="{{old('jml_laki')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_perempuan') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_perempuan" type="text" class="form-control" id="jml_perempuan"
                                        aria-describedby="" placeholder="" value="{{old('jml_perempuan')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_wni_laki') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_wni_laki" type="text" class="form-control" id="jml_wni_laki"
                                        aria-describedby="" placeholder="" value="{{old('jml_wni_laki')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_wna_laki') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_wna_laki" type="text" class="form-control" id="jml_wna_laki"
                                        aria-describedby="" placeholder="" value="{{old('jml_wna_laki')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_islam') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_islam" type="text" class="form-control" id="jml_islam"
                                        aria-describedby="" placeholder="" value="{{old('jml_islam')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_katholik') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_katholik" type="text" class="form-control" id="jml_katholik"
                                        aria-describedby="" placeholder="" value="{{old('jml_katholik')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_protestan') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_protestan" type="text" class="form-control" id="jml_protestan"
                                        aria-describedby="" placeholder="" value="{{old('jml_protestan')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_hindu') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_hindu" type="text" class="form-control" id="jml_hindu"
                                        aria-describedby="" placeholder="" value="{{old('jml_hindu')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_budha') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_budha" type="text" class="form-control" id="jml_budha"
                                        aria-describedby="" placeholder="" value="{{old('jml_budha')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_0_4') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_0_4" type="text" class="form-control" id="jml_0_4"
                                        aria-describedby="" placeholder="" value="{{old('jml_0_4')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_5_9') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_5_9" type="text" class="form-control" id="jml_5_9"
                                        aria-describedby="" placeholder="" value="{{old('jml_5_9')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_10_14') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_10_14" type="text" class="form-control" id="jml_10_14"
                                        aria-describedby="" placeholder="" value="{{old('jml_10_14')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_15_19') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_15_19" type="text" class="form-control" id="jml_15_19"
                                        aria-describedby="" placeholder="" value="{{old('jml_15_19')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_20_24') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_20_24" type="text" class="form-control" id="jml_20_24"
                                        aria-describedby="" placeholder="" value="{{old('jml_20_24')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_25_29') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_25_29" type="text" class="form-control" id="jml_25_29"
                                        aria-describedby="" placeholder="" value="{{old('jml_25_29')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_30_34') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_30_34" type="text" class="form-control" id="jml_30_34"
                                        aria-describedby="" placeholder="" value="{{old('jml_30_34')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_35_39') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_35_39" type="text" class="form-control" id="jml_35_39"
                                        aria-describedby="" placeholder="" value="{{old('jml_35_39')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_40_44') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_40_44" type="text" class="form-control" id="jml_40_44"
                                        aria-describedby="" placeholder="" value="{{old('jml_40_44')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_45_49') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_45_49" type="text" class="form-control" id="jml_45_49"
                                        aria-describedby="" placeholder="" value="{{old('jml_45_49')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_50_54') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_50_54" type="text" class="form-control" id="jml_50_54"
                                        aria-describedby="" placeholder="" value="{{old('jml_50_54')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_55_59') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_55_59" type="text" class="form-control" id="jml_55_59"
                                        aria-describedby="" placeholder="" value="{{old('jml_55_59')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_60_64') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_60_64" type="text" class="form-control" id="jml_60_64"
                                        aria-describedby="" placeholder="" value="{{old('jml_60_64')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_65_69') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_65_69" type="text" class="form-control" id="jml_65_69"
                                        aria-describedby="" placeholder="" value="{{old('jml_65_69')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_70_74') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_70_74" type="text" class="form-control" id="jml_70_74"
                                        aria-describedby="" placeholder="" value="{{old('jml_70_74')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_75_up') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_75_up" type="text" class="form-control" id="jml_75_up"
                                        aria-describedby="" placeholder="" value="{{old('jml_75_up')}}">
                                ...
                                <div class="form-group row {{$errors->has('pindah_l') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="pindah_l" type="text" class="form-control" id="pindah_l"
                                            aria-describedby="" placeholder="" value="{{old('pindah_l')}}">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input name="pindah_p" type="text" class="form-control" id="pindah_p"
                                            aria-describedby="" placeholder="" value="{{old('pindah_p')}}">
                                ...
                                <div class="form-group row {{$errors->has('datang_l') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="datang_l" type="text" class="form-control" id="datang_l"
                                            aria-describedby="" placeholder="" value="{{old('datang_l')}}">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input name="datang_p" type="text" class="form-control" id="datang_p"
                                            aria-describedby="" placeholder="" value="{{old('datang_p')}}">
                                ...
                                <div class="form-group row {{$errors->has('lahir_l') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="lahir_l" type="text" class="form-control" id="lahir_l"
                                            aria-describedby="" placeholder="" value="{{old('lahir_l')}}">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input name="lahir_p" type="text" class="form-control" id="lahir_p"
                                            aria-describedby="" placeholder="" value="{{old('lahir_p')}}">
                                ...
                                <div class="form-group row {{$errors->has('mati_l') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="mati_l" type="text" class="form-control" id="mati_l"
                                            aria-describedby="" placeholder="" value="{{old('mati_l')}}">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input name="mati_p" type="text" class="form-control" id="mati_p"
                                            aria-describedby="" placeholder="" value="{{old('mati_p')}}">
                        ...
                        <div class="form-group row {{$errors->has('matilebih5_l') ? 'has-error' : ''}} ">
                            <div class="col-sm-6">
                                ...
                                <input name="matilebih5_l" type="text" class="form-control" id="matilebih5_l"
                                    aria-describedby="" placeholder="" value="{{old('matilebih5_l')}}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input name="matilebih5_p" type="text" class="form-control" id="matilebih5_p"
                                    aria-describedby="" placeholder="" value="{{old('matilebih5_p')}}">
                        ...
                        <div class="form-group {{$errors->has('kepadatan') ? 'has-error' : ''}} ">
                            ...
                            <input name="kepadatan" type="text" class="form-control" id="kepadatan" aria-describedby=""
                                placeholder="per Km2" value="{{old('kepadatan')}}">
                        ...
                        <div class="form-group {{$errors->has('penyebaran') ? 'has-error' : ''}} ">
                            ...
                            <input name="penyebaran" type="text" class="form-control" id="penyebaran"
                                aria-describedby="" placeholder="" value="{{old('penyebaran')}}">
                        ...
                        <div class="form-group {{$errors->has('ntcr_nikah') ? 'has-error' : ''}} ">
                            ...
                            <input name="ntcr_nikah" type="text" class="form-control" id="ntcr_nikah"
                                aria-describedby="" placeholder="" value="{{old('ntcr_nikah')}}">
                        ...
                        <div class="form-group {{$errors->has('ntcr_talak') ? 'has-error' : ''}} ">
                            ...
                            <input name="ntcr_talak" type="text" class="form-control" id="ntcr_talak"
                                aria-describedby="" placeholder="" value="{{old('ntcr_talak')}}">
                        ...
                        <div class="form-group {{$errors->has('ntcr_cerai') ? 'has-error' : ''}} ">
                            ...
                            <input name="ntcr_cerai" type="text" class="form-control" id="ntcr_cerai"
                                aria-describedby="" placeholder="" value="{{old('ntcr_cerai')}}">
                        ...
                        <div class="form-group {{$errors->has('ntcr_rujuk') ? 'has-error' : ''}} ">
                            ...
                            <input name="ntcr_rujuk" type="text" class="form-control" id="ntcr_rujuk"
                                aria-describedby="" placeholder="" value="{{old('ntcr_rujuk')}}">
                        ...
                        <div class="form-group {{$errors->has('petani_pemilik') ? 'has-error' : ''}} ">
                            ...
                            <input name="petani_pemilik" type="text" class="form-control" id="petani_pemilik"
                                aria-describedby="" placeholder="" value="{{old('petani_pemilik')}}">
                        ...
                        <div class="form-group {{$errors->has('petani_penggarap') ? 'has-error' : ''}} ">
                            ...
                            <input name="petani_penggarap" type="text" class="form-control" id="petani_penggarap"
                                aria-describedby="" placeholder="" value="{{old('petani_penggarap')}}">
                        ...
                        <div class="form-group {{$errors->has('petani_penyekap') ? 'has-error' : ''}} ">
                            ...
                            <input name="petani_penyekap" type="text" class="form-control" id="petani_penyekap"
                                aria-describedby="" placeholder="" value="{{old('petani_penyekap')}}">
                        ...
                        <div class="form-group {{$errors->has('petani_buruh') ? 'has-error' : ''}} ">
                            ...
                            <input name="petani_buruh" type="text" class="form-control" id="petani_buruh"
                                aria-describedby="" placeholder="" value="{{old('petani_buruh')}}">
                        ...
                        <div class="form-group {{$errors->has('pengusaha_sedang') ? 'has-error' : ''}} ">
                            ...
                            <input name="pengusaha_sedang" type="text" class="form-control" id="pengusaha_sedang"
                                aria-describedby="" placeholder="" value="{{old('pengusaha_sedang')}}">
                        ...
                        <div class="form-group {{$errors->has('pengrajin') ? 'has-error' : ''}} ">
                            ...
                            <input name="pengrajin" type="text" class="form-control" id="pengrajin" aria-describedby=""
                                placeholder="" value="{{old('pengrajin')}}">
                        ...
                        <div class="form-group {{$errors->has('buruh_industri') ? 'has-error' : ''}} ">
                            ...
                            <input name="buruh_industri" type="text" class="form-control" id="buruh_industri"
                                aria-describedby="" placeholder="" value="{{old('buruh_industri')}}">
                        ...
                        <div class="form-group {{$errors->has('buruh_bangunan') ? 'has-error' : ''}} ">
                            ...
                            <input name="buruh_bangunan" type="text" class="form-control" id="buruh_bangunan"
                                aria-describedby="" placeholder="" value="{{old('buruh_bangunan')}}">
                        ...
                        <div class="form-group {{$errors->has('buruh_pertambangan') ? 'has-error' : ''}} ">
                            ...
                            <input name="buruh_pertambangan" type="text" class="form-control" id="buruh_pertambangan"
                                aria-describedby="" placeholder="" value="{{old('buruh_pertambangan')}}">
                        ...
                        <div class="form-group {{$errors->has('buruh_perkebunan') ? 'has-error' : ''}} ">
                            ...
                            <input name="buruh_perkebunan" type="text" class="form-control" id="buruh_perkebunan"
                                aria-describedby="" placeholder="" value="{{old('buruh_perkebunan')}}">
                        ...
                        <div class="form-group {{$errors->has('pedagang') ? 'has-error' : ''}} ">
                            ...
                            <input name="pedagang" type="text" class="form-control" id="pedagang" aria-describedby=""
                                placeholder="" value="{{old('pedagang')}}">
                        ...
                        <div class="form-group {{$errors->has('pengangkutan') ? 'has-error' : ''}} ">
                            ...
                            <input name="pengangkutan" type="text" class="form-control" id="pengangkutan"
                                aria-describedby="" placeholder="" value="{{old('pengangkutan')}}">
                        ...
                        <div class="form-group {{$errors->has('peternak_sapi_perah') ? 'has-error' : ''}} ">
                            ...
                            <input name="peternak_sapi_perah" type="text" class="form-control" id="peternak_sapi_perah"
                                aria-describedby="" placeholder="" value="{{old('peternak_sapi_perah')}}">
                        ...
                        <div class="form-group {{$errors->has('peternak_sapi_biasa') ? 'has-error' : ''}} ">
                            ...
                            <input name="peternak_sapi_biasa" type="text" class="form-control" id="peternak_sapi_biasa"
                                aria-describedby="" placeholder="" value="{{old('peternak_sapi_biasa')}}">
                        ...
                        <div class="form-group {{$errors->has('peternak_kerbau') ? 'has-error' : ''}} ">
                            ...
                            <input name="peternak_kerbau" type="text" class="form-control" id="peternak_kerbau"
                                aria-describedby="" placeholder="" value="{{old('peternak_kerbau')}}">
                        ...
                        <div class="form-group {{$errors->has('peternak_kambing') ? 'has-error' : ''}} ">
                            ...
                            <input name="peternak_kambing" type="text" class="form-control" id="peternak_kambing"
                                aria-describedby="" placeholder="" value="{{old('peternak_kambing')}}">
                        ...
                        <div class="form-group {{$errors->has('peternak_domba') ? 'has-error' : ''}} ">
                            ...
                            <input name="peternak_domba" type="text" class="form-control" id="peternak_domba"
                                aria-describedby="" placeholder="" value="{{old('peternak_domba')}}">
                        ...
                        <div class="form-group {{$errors->has('peternak_kuda') ? 'has-error' : ''}} ">
                            ...
                            <input name="peternak_kuda" type="text" class="form-control" id="peternak_kuda"
                                aria-describedby="" placeholder="" value="{{old('peternak_kuda')}}">
