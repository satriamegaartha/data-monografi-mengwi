                ...
                <div class="col-md-12"> 
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">                                                        
                            ...
                            <a href="/dinamis/pemkecamatan/{{$pemkecamatan->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                            <a href="/dinamis/pemkecamatan/{{$pemkecamatan->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Data akan dihapus?')">Delete</a>
                        </div>
                    </div>
