                ...
                <div class="col-md-12"> 
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Tambah Data Pemerintahan Kecamatan</h3>
                        </div>
                        <div class="panel-body">                                                        
                            <form method="POST" action="/dinamis/pemkecamatan/create">
                                @csrf                                                        
                                <div class="row">
                                    <div class="col-xs-3">
                                ...
                                <div class="form-group {{$errors->has('jml_pegawai_ktr') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_pegawai_ktr" type="text" class="form-control" id="jml_pegawai_ktr" aria-describedby="" placeholder="Pegawai" value="{{old('jml_pegawai_ktr')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_pegawai_ktr_gol4') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_pegawai_ktr_gol4" type="text" class="form-control" id="jml_pegawai_ktr_gol4" aria-describedby="" placeholder="Pegawai" value="{{old('jml_pegawai_ktr_gol4')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_pegawai_ktr_gol3') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_pegawai_ktr_gol3" type="text" class="form-control" id="jml_pegawai_ktr_gol3" aria-describedby="" placeholder="Pegawai" value="{{old('jml_pegawai_ktr_gol3')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_pegawai_ktr_gol2') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_pegawai_ktr_gol2" type="text" class="form-control" id="jml_pegawai_ktr_gol2" aria-describedby="" placeholder="Pegawai" value="{{old('jml_pegawai_ktr_gol2')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_pegawai_ktr_gol1') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_pegawai_ktr_gol1" type="text" class="form-control" id="jml_pegawai_ktr_gol1" aria-describedby="" placeholder="Pegawai" value="{{old('jml_pegawai_ktr_gol1')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_non_pegawai_ktr') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_non_pegawai_ktr" type="text" class="form-control" id="jml_non_pegawai_ktr" aria-describedby="" placeholder="Pegawai" value="{{old('jml_non_pegawai_ktr')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_non_pegawai_ktr_gol4') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_non_pegawai_ktr_gol4" type="text" class="form-control" id="jml_non_pegawai_ktr_gol4" aria-describedby="" placeholder="Pegawai" value="{{old('jml_non_pegawai_ktr_gol4')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_non_pegawai_ktr_gol3') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_non_pegawai_ktr_gol3" type="text" class="form-control" id="jml_non_pegawai_ktr_gol3" aria-describedby="" placeholder="Pegawai" value="{{old('jml_non_pegawai_ktr_gol3')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_non_pegawai_ktr_gol2') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_non_pegawai_ktr_gol2" type="text" class="form-control" id="jml_non_pegawai_ktr_gol2" aria-describedby="" placeholder="Pegawai" value="{{old('jml_non_pegawai_ktr_gol2')}}">
                                ...
                                <div class="form-group {{$errors->has('jml_non_pegawai_ktr_gol1') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jml_non_pegawai_ktr_gol1" type="text" class="form-control" id="jml_non_pegawai_ktr_gol1" aria-describedby="" placeholder="Pegawai" value="{{old('jml_non_pegawai_ktr_gol1')}}">
                                ...
                                <div class="form-group {{$errors->has('telepon') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="telepon" type="text" class="form-control" id="telepon" aria-describedby="" placeholder="Buah" value="{{old('telepon')}}">
                                ...
                                <div class="form-group {{$errors->has('radio') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="radio" type="text" class="form-control" id="radio" aria-describedby="" placeholder="Buah" value="{{old('radio')}}">
                                    @if ($errors->has('radio'))
                                ...
                                <div class="form-group {{$errors->has('mesin_tik') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="mesin_tik" type="text" class="form-control" id="mesin_tik" aria-describedby="" placeholder="Buah" value="{{old('mesin_tik')}}">
                                ...
                                <div class="form-group {{$errors->has('meja_kerja') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="meja_kerja" type="text" class="form-control" id="meja_kerja" aria-describedby="" placeholder="Buah" value="{{old('meja_kerja')}}">
                                ...
                                <div class="form-group {{$errors->has('kursi_kerja') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="kursi_kerja" type="text" class="form-control" id="kursi_kerja" aria-describedby="" placeholder="Buah" value="{{old('kursi_kerja')}}">
                                ...
                                <div class="form-group {{$errors->has('meja_kursi_tamu') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="meja_kursi_tamu" type="text" class="form-control" id="meja_kursi_tamu" aria-describedby="" placeholder="Buah" value="{{old('meja_kursi_tamu')}}">
                                ...
                                <div class="form-group {{$errors->has('lemari') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="lemari" type="text" class="form-control" id="lemari" aria-describedby="" placeholder="Buah" value="{{old('lemari')}}">
                                ...
                                <div class="form-group {{$errors->has('r_rapat') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="r_rapat" type="text" class="form-control" id="r_rapat" aria-describedby="" placeholder="Buah" value="{{old('r_rapat')}}">
                                ...
                                <div class="form-group {{$errors->has('r_data') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="r_data" type="text" class="form-control" id="r_data" aria-describedby="" placeholder="Buah" value="{{old('r_data')}}">
                                ...
                                <div class="form-group {{$errors->has('serba_guna') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="serba_guna" type="text" class="form-control" id="serba_guna" aria-describedby="" placeholder="Buah" value="{{old('serba_guna')}}">
                                ...
                                <div class="form-group {{$errors->has('balai_pertemuan') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="balai_pertemuan" type="text" class="form-control" id="balai_pertemuan" aria-describedby="" placeholder="Buah" value="{{old('balai_pertemuan')}}">
                                ...
                                <div class="form-group {{$errors->has('kendaraan_roda2') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="kendaraan_roda2" type="text" class="form-control" id="kendaraan_roda2" aria-describedby="" placeholder="Buah" value="{{old('kendaraan_roda2')}}">
                                ...
                                <div class="form-group {{$errors->has('kendaraan_roda4') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="kendaraan_roda4" type="text" class="form-control" id="kendaraan_roda4" aria-describedby="" placeholder="Buah" value="{{old('kendaraan_roda4')}}">
                                ...
                                <div class="form-group {{$errors->has('mesin_hitung') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="mesin_hitung" type="text" class="form-control" id="mesin_hitung" aria-describedby="" placeholder="Buah" value="{{old('mesin_hitung')}}">
                                ...
                                <div class="form-group {{$errors->has('lain') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="lain" type="text" class="form-control" id="lain" aria-describedby="" placeholder="Buah" value="{{old('lain')}}">
                                    @if ($errors->has('lain'))
