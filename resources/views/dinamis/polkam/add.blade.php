                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form method="POST" action="/dinamis/polkam/create">
                                @csrf
                                <div class="row">
                                    <div class="col-xs-3">
                                ...
                                <div class="form-group row {{$errors->has('pencurian_banyak') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row {{$errors->has('perampokan_banyak') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row {{$errors->has('pembunuhan_banyak') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row {{$errors->has('pemerkosaan_banyak') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input name="pemerkosaan_kerugian" type="text" class="form-control"
                                            ...
                                            value="{{old('pemerkosaan_kerugian')}}">
                                ...
                                <div class="form-group row {{$errors->has('narkoba_banyak') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="narkoba_banyak" type="text" class="form-control"
                                            id="narkoba_banyak" aria-describedby="" value="{{old('narkoba_banyak')}}">
                                ...
                                <div class="form-group row {{$errors->has('lainnya_banyak') ? 'has-error' : ''}} ">
                                    <div class="col-sm-6">
                                        ...
                                        <input name="lainnya_banyak" type="text" class="form-control"
                                            id="lainnya_banyak" aria-describedby="" value="{{old('lainnya_banyak')}}">
                                ...
                                <div class="form-group row {{$errors->has('jumlah_hansip') ? 'has-error' : ''}} ">
                                    <div class="col-sm-12">
                                        ...
                                        <input name="jumlah_hansip" type="text" class="form-control" id="jumlah_hansip"
                                            aria-describedby="" value="{{old('jumlah_hansip')}}">
                                ...
                                <div class="form-group row {{$errors->has('jumlah_menwa') ? 'has-error' : ''}} ">
                                    <div class="col-sm-12">
                                        ...
                                        <input name="jumlah_menwa" type="text" class="form-control" id="jumlah_menwa"
                                            aria-describedby="" value="{{old('jumlah_menwa')}}">
                                ...
                                <div class="form-group row {{$errors->has('jumlah_kemra') ? 'has-error' : ''}} ">
                                    <div class="col-sm-12">
                                        ...
                                        <input name="jumlah_kemra" type="text" class="form-control" id="jumlah_kemra"
                                            aria-describedby="" value="{{old('jumlah_kemra')}}">
                                        @if ($errors->has('jumlah_kemra'))
                                        <span class="help-block">{{$errors->first('jumlah_kemra')}}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group row {{$errors->has('jumlah_pos_kamling') ? 'has-error' : ''}} ">
                                    <div class="col-sm-12">
