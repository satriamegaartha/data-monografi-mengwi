                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form method="POST" action="/dinamis/transportasi/create">
                                @csrf
                                <div class="row">
                                    <div class="col-xs-3">
                                ...
                                <label for="">
                                    <h5><strong>1. Jenis Alat Angkutan Lokal Yang Digunakan Di Kecamatan</strong></h5>
                                </label>
                                <div class="form-group {{$errors->has('sepeda') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="sepeda" type="text" class="form-control" id="sepeda"
                                        aria-describedby="" placeholder="" value="{{old('sepeda')}}">
                                ...
                                <div class="form-group {{$errors->has('dokar') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="dokar" type="text" class="form-control" id="dokar" aria-describedby=""
                                        placeholder="" value="{{old('dokar')}}">
                                    @if ($errors->has('dokar'))
                                ...
                                <div class="form-group {{$errors->has('gerobak') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="gerobak" type="text" class="form-control" id="gerobak"
                                        aria-describedby="" placeholder="" value="{{old('gerobak')}}">
                                ...
                                <div class="form-group {{$errors->has('becak') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="becak" type="text" class="form-control" id="becak" aria-describedby=""
                                        placeholder="" value="{{old('becak')}}">
                                    @if ($errors->has('becak'))
                                ...
                                <div class="form-group {{$errors->has('roda3') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="roda3" type="text" class="form-control" id="roda3" aria-describedby=""
                                        placeholder="" value="{{old('roda3')}}">
                                    @if ($errors->has('roda3'))
                                ...
                                <div class="form-group {{$errors->has('motor') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="motor" type="text" class="form-control" id="motor" aria-describedby=""
                                        placeholder="" value="{{old('motor')}}">
                                    @if ($errors->has('motor'))
                                ...
                                <div class="form-group {{$errors->has('oplet') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="oplet" type="text" class="form-control" id="oplet" aria-describedby=""
                                        placeholder="" value="{{old('oplet')}}">
                                    @if ($errors->has('oplet'))
                                ...
                                <div class="form-group {{$errors->has('taksi') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="taksi" type="text" class="form-control" id="taksi" aria-describedby=""
                                        placeholder="" value="{{old('taksi')}}">
                                    @if ($errors->has('taksi'))
                                ...
                                <div class="form-group {{$errors->has('mobil_dinas') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="mobil_dinas" type="text" class="form-control" id="mobil_dinas"
                                        aria-describedby="" placeholder="" value="{{old('mobil_dinas')}}">
                                ...
                                <div class="form-group {{$errors->has('mobil_pribadi') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="mobil_pribadi" type="text" class="form-control" id="mobil_pribadi"
                                        aria-describedby="" placeholder="" value="{{old('mobil_pribadi')}}">
                                ...
                                <div class="form-group {{$errors->has('truck') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="truck" type="text" class="form-control" id="truck" aria-describedby=""
                                        placeholder="" value="{{old('truck')}}">
                                    @if ($errors->has('truck'))
                                ...
                                <div class="form-group {{$errors->has('bus_umum') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="bus_umum" type="text" class="form-control" id="bus_umum"
                                        aria-describedby="" placeholder="" value="{{old('bus_umum')}}">
                                ...
                                <div class="form-group {{$errors->has('bus_kota') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="bus_kota" type="text" class="form-control" id="bus_kota"
                                        aria-describedby="" placeholder="" value="{{old('bus_kota')}}">
                                ...
                                <div class="form-group {{$errors->has('perahu_dayung') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="perahu_dayung" type="text" class="form-control" id="perahu_dayung"
                                        aria-describedby="" placeholder="" value="{{old('perahu_dayung')}}">
                                ...
                                <div class="form-group {{$errors->has('perahu_motor') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="perahu_motor" type="text" class="form-control" id="perahu_motor"
                                        aria-describedby="" placeholder="" value="{{old('perahu_motor')}}">
                                ...
                                <div class="form-group {{$errors->has('perahu_layar') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="perahu_layar" type="text" class="form-control" id="perahu_layar"
                                        aria-describedby="" placeholder="" value="{{old('perahu_layar')}}">
                                ...
                                <div class="form-group {{$errors->has('lainnya') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="lainnya" type="text" class="form-control" id="lainnya"
                                        aria-describedby="" placeholder="" value="{{old('lainnya')}}">
                                ...
                                <div class="form-group {{$errors->has('tv_umum') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tv_umum" type="text" class="form-control" id="tv_umum"
                                        aria-describedby="" placeholder="" value="{{old('tv_umum')}}">
                                ...
                                <div class="form-group {{$errors->has('telp_umum') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="telp_umum" type="text" class="form-control" id="telp_umum"
                                        aria-describedby="" placeholder="" value="{{old('telp_umum')}}">
                                ...
                                <div class="form-group {{$errors->has('kantor_pos') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="kantor_pos" type="text" class="form-control" id="kantor_pos"
                                        aria-describedby="" placeholder="" value="{{old('kantor_pos')}}">
                                ...
                                <div class="form-group {{$errors->has('orari') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="orari" type="text" class="form-control" id="orari" aria-describedby=""
                                        placeholder="" value="{{old('orari')}}">
                                    @if ($errors->has('orari'))
                                ...
                                <div class="form-group {{$errors->has('pemancar_radio') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="pemancar_radio" type="text" class="form-control" id="pemancar_radio"
                                        aria-describedby="" placeholder="" value="{{old('pemancar_radio')}}">
                                ...
                                <div class="form-group {{$errors->has('listrik_pln') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="listrik_pln" type="text" class="form-control" id="listrik_pln"
                                        aria-describedby="" placeholder="" value="{{old('listrik_pln')}}">
                                ...
                                <div class="form-group {{$errors->has('listrik_non_pln') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="listrik_non_pln" type="text" class="form-control" id="listrik_non_pln"
                                        aria-describedby="" placeholder="" value="{{old('listrik_non_pln')}}">
                                ...
                                <div class="form-group {{$errors->has('pompa') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="pompa" type="text" class="form-control" id="pompa" aria-describedby=""
                                        placeholder="" value="{{old('pompa')}}">
                                    @if ($errors->has('pompa'))
                                ...
                                <div class="form-group {{$errors->has('sumur') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="sumur" type="text" class="form-control" id="sumur" aria-describedby=""
                                        placeholder="" value="{{old('sumur')}}">
                                    @if ($errors->has('sumur'))
