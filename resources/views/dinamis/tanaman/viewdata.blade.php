                        ...
                        <div class="panel-body">
                            <form method="POST" action="#">
                                <fieldset disabled="disabled">
                                    ...
                                    <div
                                        class="form-group row {{$errors->has('padi_luas_tanaman') ? 'has-error' : ''}} ">
                                        <div class="col-sm-3">
                                    ...
                                    <div
                                        class="form-group row {{$errors->has('jagung_luas_tanaman') ? 'has-error' : ''}} ">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input name="jagung_jumlah" type="text" class="form-control"
                                                id="jagung_jumlah" aria-describedby="" placeholder=""
                                                value="{{$tanaman->jagung_jumlah}}">
                                    ...
                                    <div
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <span
                                                class="help-block">{{$errors->first('ketela_pohon_luas_tanaman')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <span
                                                class="help-block">{{$errors->first('ketela_pohon_luas_panen')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <span
                                                class="help-block">{{$errors->first('ketela_rambat_luas_tanaman')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <span
                                                class="help-block">{{$errors->first('ketela_rambat_luas_panen')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <span
                                                class="help-block">{{$errors->first('kacang_tanah_luas_tanaman')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <span
                                                class="help-block">{{$errors->first('kacang_tanah_luas_panen')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div
                                        class="form-group row {{$errors->has('sayur_luas_tanaman') ? 'has-error' : ''}} ">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input name="sayur_jumlah" type="text" class="form-control"
                                                id="sayur_jumlah" aria-describedby="" placeholder=""
                                                value="{{$tanaman->sayur_jumlah}}">
                                    ...
                                    <div
                                        class="form-group row {{$errors->has('buah_luas_tanaman') ? 'has-error' : ''}} ">
                                        <div class="col-sm-3">
                                    ...
                                    <div
                                        class="form-group row {{$errors->has('lain_luas_tanaman') ? 'has-error' : ''}} ">
                                        <div class="col-sm-3">
...
<div class="form-group row {{$errors->has('cengkeh_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        <label for="cengkeh_blm_produksi">
            <h5>Belum Produksi/muda</h5>
        </label>
        <input name="cengkeh_blm_produksi" type="text" class="form-control" id="cengkeh_blm_produksi"
            aria-describedby="" value="{{$tanaman->cengkeh_blm_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="cengkeh_produksi" type="text" class="form-control" id="cengkeh_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="cengkeh_tak_produksi" type="text" class="form-control" id="cengkeh_tak_produksi"
            aria-describedby="" value="{{$tanaman->cengkeh_tak_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="cengkeh_jml_produksi" type="text" class="form-control" id="cengkeh_jml_produksi"
            aria-describedby="" placeholder="" value="{{$tanaman->cengkeh_jml_produksi}}">
...
<div class="form-group row {{$errors->has('pala_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        ...
        <input name="pala_blm_produksi" type="text" class="form-control" id="pala_blm_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="pala_produksi" type="text" class="form-control" id="pala_produksi" aria-describedby=""
            value="{{$tanaman->pala_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="pala_tak_produksi" type="text" class="form-control" id="pala_tak_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="pala_jml_produksi" type="text" class="form-control" id="pala_jml_produksi" aria-describedby=""
            placeholder="" value="{{$tanaman->pala_jml_produksi}}">
...
<div class="form-group row {{$errors->has('tembakau_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        <label for="tembakau_blm_produksi">
            <h5>Belum Produksi/muda</h5>
        </label>
        <input name="tembakau_blm_produksi" type="text" class="form-control" id="tembakau_blm_produksi"
            aria-describedby="" value="{{$tanaman->tembakau_blm_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="tembakau_produksi" type="text" class="form-control" id="tembakau_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="tembakau_tak_produksi" type="text" class="form-control" id="tembakau_tak_produksi"
            aria-describedby="" value="{{$tanaman->tembakau_tak_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="tembakau_jml_produksi" type="text" class="form-control" id="tembakau_jml_produksi"
            aria-describedby="" placeholder="" value="{{$tanaman->tembakau_jml_produksi}}">
...
<div class="form-group row {{$errors->has('kelapa_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        ...
        <input name="kelapa_blm_produksi" type="text" class="form-control" id="kelapa_blm_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="kelapa_produksi" type="text" class="form-control" id="kelapa_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="kelapa_tak_produksi" type="text" class="form-control" id="kelapa_tak_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="kelapa_jml_produksi" type="text" class="form-control" id="kelapa_jml_produksi" aria-describedby=""
            placeholder="" value="{{$tanaman->kelapa_jml_produksi}}">
...
<div class="form-group row {{$errors->has('kelapa_sawit_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        <label for="kelapa_sawit_blm_produksi">
            <h5>Belum Produksi/muda</h5>
        </label>
        <input name="kelapa_sawit_blm_produksi" type="text" class="form-control" id="kelapa_sawit_blm_produksi"
            aria-describedby="" value="{{$tanaman->kelapa_sawit_blm_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="kelapa_sawit_produksi" type="text" class="form-control" id="kelapa_sawit_produksi"
            aria-describedby="" value="{{$tanaman->kelapa_sawit_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="kelapa_sawit_tak_produksi" type="text" class="form-control" id="kelapa_sawit_tak_produksi"
            aria-describedby="" value="{{$tanaman->kelapa_sawit_tak_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="kelapa_sawit_jml_produksi" type="text" class="form-control" id="kelapa_sawit_jml_produksi"
            aria-describedby="" placeholder="" value="{{$tanaman->kelapa_sawit_jml_produksi}}">
...
<div class="form-group row {{$errors->has('kopi_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        ...
        <input name="kopi_blm_produksi" type="text" class="form-control" id="kopi_blm_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="kopi_produksi" type="text" class="form-control" id="kopi_produksi" aria-describedby=""
            value="{{$tanaman->kopi_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="kopi_tak_produksi" type="text" class="form-control" id="kopi_tak_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="kopi_jml_produksi" type="text" class="form-control" id="kopi_jml_produksi" aria-describedby=""
            placeholder="" value="{{$tanaman->kopi_jml_produksi}}">
...
<div class="form-group row {{$errors->has('coklat_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        ...
        <input name="coklat_blm_produksi" type="text" class="form-control" id="coklat_blm_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="coklat_produksi" type="text" class="form-control" id="coklat_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="coklat_tak_produksi" type="text" class="form-control" id="coklat_tak_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="coklat_jml_produksi" type="text" class="form-control" id="coklat_jml_produksi" aria-describedby=""
            placeholder="" value="{{$tanaman->coklat_jml_produksi}}">
...
<div class="form-group row {{$errors->has('panili_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        ...
        <input name="panili_blm_produksi" type="text" class="form-control" id="panili_blm_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="panili_produksi" type="text" class="form-control" id="panili_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="panili_tak_produksi" type="text" class="form-control" id="panili_tak_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="panili_jml_produksi" type="text" class="form-control" id="panili_jml_produksi" aria-describedby=""
            placeholder="" value="{{$tanaman->panili_jml_produksi}}">
...
<div class="form-group row {{$errors->has('lain_blm_produksi') ? 'has-error' : ''}} ">
    <div class="col-sm-3">
        ...
        <input name="lain_blm_produksi" type="text" class="form-control" id="lain_blm_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="lain_produksi" type="text" class="form-control" id="lain_produksi" aria-describedby=""
            value="{{$tanaman->lain_produksi}}">
    ...
    <div class="col-sm-3">
        ...
        <input name="lain_tak_produksi" type="text" class="form-control" id="lain_tak_produksi" aria-describedby=""
    ...
    <div class="col-sm-3">
        ...
        <input name="lain_jml_produksi" type="text" class="form-control" id="lain_jml_produksi" aria-describedby=""
            placeholder="" value="{{$tanaman->lain_jml_produksi}}">
