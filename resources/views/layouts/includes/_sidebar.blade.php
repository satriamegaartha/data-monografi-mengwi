    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <li>
                    <a href="/periode" class="{{(request()->segment(1) == 'periode') ? 'active' : ''}}">
                        <i class="lnr lnr-clock"></i>
                        <span>Periode</span>
                    </a>
                </li>
                <li>
                    <a href="#dataStatis" class=" {{(request()->segment(1) == 'statis') ? 'active' : ''}}"
                        data-toggle="collapse" class="collapsed" aria-expanded="false"><i class="lnr lnr-pencil"></i>
                        <span>Data Statis</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
                    <div id="dataStatis" class="collapse" aria-expanded="false" style="height: 0px;">
                        <ul class="nav">
                            <li><a href="/statis/kumum"
                                    class="{{(request()->segment(2) == 'kumum') ? 'active' : ''}}">Keterangan Umum</a>
                            </li>
                            ...
                            <li><a href="/statis/pjgjalan"
                                    class="{{(request()->segment(2) == 'pjgjalan') ? 'active' : ''}}">Panjang Jalan dan
                                    Jembatan</a></li>
                ...
                <li>
                    <a href="#dataDinamis" data-toggle="collapse"
                        class=" {{(request()->segment(1) == 'dinamis') ? 'active' : ''}}" aria-expanded="false"><i
                            class="lnr lnr-tag"></i> <span>Data Dinamis</span> <i
