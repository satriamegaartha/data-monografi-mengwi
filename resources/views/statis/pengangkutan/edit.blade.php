                        ...
                        <div class="panel-body">
                            <form method="POST" action="/statis/pengangkutan/{{$pengangkutan->id}}/update">
                                    ...
                                    <div class="col-xs-3">
                                        <div class="form-group {{$errors->has('tanggal') ? 'has-error' : ''}} ">
                                            ...
                                            <input name="tanggal" type="date" class="form-control" id="tanggal"
                                                aria-describedby="" placeholder="" value="{{$pengangkutan->tanggal}}">
                                ...
                                <div class="form-group {{$errors->has('darat') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="darat" type="text" class="form-control" id="darat" aria-describedby=""
                                        placeholder="" value="{{$pengangkutan->darat}}">
                                    @if ($errors->has('darat'))
                                ...
                                <div class="form-group {{$errors->has('aspal') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="aspal" type="text" class="form-control" id="aspal" aria-describedby=""
                                        placeholder="Km" value="{{$pengangkutan->aspal}}">
                                    @if ($errors->has('aspal'))
                                ...
                                <div class="form-group {{$errors->has('tanah') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="tanah" type="text" class="form-control" id="tanah" aria-describedby=""
                                        placeholder="Km" value="{{$pengangkutan->tanah}}">
                                    @if ($errors->has('tanah'))
