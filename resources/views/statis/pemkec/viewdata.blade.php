                ...
                <div class="col-md-12"> 
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h4>{{date_format(date_create($pemkec->tanggal),"d F Y")}}</h4>
                        </div>
                        <div class="panel-body">                                                        
                            <form method="POST" action="/statis/pemkec/{{$pemkec->id}}/update">
                                <fieldset disabled>
                                    ...
                                    <div class="form-group {{$errors->has('kp_status') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_status" type="text" class="form-control" id="kp_status" aria-describedby="" placeholder="" value="{{$pemkec->kp_status}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_tanah') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_tanah" type="text" class="form-control" id="kp_tanah" aria-describedby="" placeholder="m2" value="{{$pemkec->kp_tanah}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_bangunan') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_bangunan" type="text" class="form-control" id="kp_bangunan" aria-describedby="" placeholder="m" value="{{$pemkec->kp_bangunan}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_tahun') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_tahun" type="text" class="form-control" id="kp_tahun" aria-describedby="" placeholder="" value="{{$pemkec->kp_tahun}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_sdana') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_sdana" type="text" class="form-control" id="kp_sdana" aria-describedby="" placeholder="Rp" value="{{$pemkec->kp_sdana}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_apbn') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_apbn" type="text" class="form-control" id="kp_apbn" aria-describedby="" placeholder="Rp" value="{{$pemkec->kp_apbn}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_inpres') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_inpres" type="text" class="form-control" id="kp_inpres" aria-describedby="" placeholder="Rp" value="{{$pemkec->kp_inpres}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_apbd1') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_apbd1" type="text" class="form-control" id="kp_apbd1" aria-describedby="" placeholder="Rp" value="{{$pemkec->kp_apbd1}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_apbd2') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_apbd2" type="text" class="form-control" id="kp_apbd2" aria-describedby="" placeholder="Rp" value="{{$pemkec->kp_apbd2}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_lain') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_lain" type="text" class="form-control" id="kp_lain" aria-describedby="" placeholder="Rp" value="{{$pemkec->kp_lain}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_jumlah') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_jumlah" type="text" class="form-control" id="kp_jumlah" aria-describedby="" placeholder="Rp" value="{{$pemkec->kp_jumlah}}">
                                    ...
                                    <div class="form-group {{$errors->has('kp_tingkat') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="kp_tingkat" type="text" class="form-control" id="kp_tingkat" aria-describedby="" placeholder="Ya/Tidak" value="{{$pemkec->kp_tingkat}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_status') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_status" type="text" class="form-control" id="rc_status" aria-describedby="" placeholder="" value="{{$pemkec->rc_status}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_luas') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_luas" type="text" class="form-control" id="rc_luas" aria-describedby="" placeholder="m2" value="{{$pemkec->rc_luas}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_tahun') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_tahun" type="text" class="form-control" id="rc_tahun" aria-describedby="" placeholder="" value="{{$pemkec->rc_tahun}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_sdana') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_sdana" type="text" class="form-control" id="rc_sdana" aria-describedby="" placeholder="Rp" value="{{$pemkec->rc_sdana}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_apbn') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_apbn" type="text" class="form-control" id="rc_apbn" aria-describedby="" placeholder="Rp" value="{{$pemkec->rc_apbn}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_apbd1') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_apbd1" type="text" class="form-control" id="rc_apbd1" aria-describedby="" placeholder="Rp" value="{{$pemkec->rc_apbd1}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_apbd2') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_apbd2" type="text" class="form-control" id="rc_apbd2" aria-describedby="" placeholder="Rp" value="{{$pemkec->rc_apbd2}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_swadaya') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_swadaya" type="text" class="form-control" id="rc_swadaya" aria-describedby="" placeholder="Rp" value="{{$pemkec->rc_swadaya}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_jumlah') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_jumlah" type="text" class="form-control" id="rc_jumlah" aria-describedby="" placeholder="Rp" value="{{$pemkec->rc_jumlah}}">
                                    ...
                                    <div class="form-group {{$errors->has('rc_kondisi') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="rc_kondisi" type="text" class="form-control" id="rc_kondisi" aria-describedby="" placeholder="" value="{{$pemkec->rc_kondisi}}">
                                    ...
                                    <div class="form-group {{$errors->has('ins_vertikal') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="ins_vertikal" type="text" class="form-control" id="ins_vertikal" aria-describedby="" placeholder="Unit" value="{{$pemkec->ins_vertikal}}">
                                    ...
                                    <div class="form-group {{$errors->has('ins_otonom') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="ins_otonom" type="text" class="form-control" id="ins_otonom" aria-describedby="" placeholder="Unit" value="{{$pemkec->ins_otonom}}">
                                    ...
                                    <div class="form-group {{$errors->has('ins_bumn') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="ins_bumn" type="text" class="form-control" id="ins_bumn" aria-describedby="" placeholder="Unit" value="{{$pemkec->ins_bumn}}">
                                    ...
                                    <div class="form-group {{$errors->has('ins_jumlah') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="ins_jumlah" type="text" class="form-control" id="ins_jumlah" aria-describedby="" placeholder="Unit" value="{{$pemkec->ins_jumlah}}">
                                    ...
                                    <div class="form-group {{$errors->has('pegawai_dpk1') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="pegawai_dpk1" type="text" class="form-control" id="pegawai_dpk1" aria-describedby="" placeholder="Orang" value="{{$pemkec->pegawai_dpk1}}">
                                    ...
                                    <div class="form-group {{$errors->has('pegawai_dpk2') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="pegawai_dpk2" type="text" class="form-control" id="pegawai_dpk2" aria-describedby="" placeholder="Orang" value="{{$pemkec->pegawai_dpk2}}">
                                    ...
                                    <div class="form-group {{$errors->has('pegawai_daerah') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="pegawai_daerah" type="text" class="form-control" id="pegawai_daerah" aria-describedby="" placeholder="Orang" value="{{$pemkec->pegawai_daerah}}">
                                    ...
                                    <div class="form-group {{$errors->has('eselon3a') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="eselon3a" type="text" class="form-control" id="eselon3a" aria-describedby="" placeholder="Pejabat" value="{{$pemkec->eselon3a}}">
                                    ...
                                    <div class="form-group {{$errors->has('eselon3b') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="eselon3b" type="text" class="form-control" id="eselon3b" aria-describedby="" placeholder="Pejabat" value="{{$pemkec->eselon3b}}">
                                    ...
                                    <div class="form-group {{$errors->has('eselon4') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="eselon4" type="text" class="form-control" id="eselon4" aria-describedby="" placeholder="Pejabat" value="{{$pemkec->eselon4}}">
                                    ...
                                    <div class="form-group {{$errors->has('eselon5') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="eselon5" type="text" class="form-control" id="eselon5" aria-describedby="" placeholder="Pejabat" value="{{$pemkec->eselon5}}">
                                    ...
                                    <div class="form-group {{$errors->has('tipe_kec') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="tipe_kec" type="text" class="form-control" id="tipe_kec" aria-describedby="" placeholder="" value="{{$pemkec->tipe_kec}}">
                                    ...
                                    <div class="form-group {{$errors->has('lomba_kec') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="lomba_kec" type="text" class="form-control" id="lomba_kec" aria-describedby="" placeholder="" value="{{$pemkec->lomba_kec}}">
                                    ...
                                    <div class="form-group {{$errors->has('lomba_kec_juara1') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="lomba_kec_juara1" type="text" class="form-control" id="lomba_kec_juara1" aria-describedby="" placeholder="Kali" value="{{$pemkec->lomba_kec_juara1}}">
                                    ...
                                    <div class="form-group {{$errors->has('lomba_kec_juara2') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="lomba_kec_juara2" type="text" class="form-control" id="lomba_kec_juara2" aria-describedby="" placeholder="Kali" value="{{$pemkec->lomba_kec_juara2}}">
                                    ...
                                    <div class="form-group {{$errors->has('lomba_kec_juara3') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="lomba_kec_juara3" type="text" class="form-control" id="lomba_kec_juara3" aria-describedby="" placeholder="Kali" value="{{$pemkec->lomba_kec_juara3}}">
                            ...
                            <a href="/statis/pemkec/{{$pemkec->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Data akan dihapus?')">Delete</a>
                        </div>
                    </div>
