                        ...
                        <div class="panel-body">
                            <form method="POST" action="/statis/jumlahusaha/create">
                                <fieldset disabled="disabled">
                                    ...
                                    <div
                                        class="form-group row {{$errors->has('industri_rtangga') ? 'has-error' : ''}} ">
                                        <div class="col-sm-6">
                            ...
                            <a href="/statis/jumlahusaha/{{$jumlahusaha->id}}/edit"
