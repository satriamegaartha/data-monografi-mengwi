                        ...
                        <div class="panel-body">
                            <form method="POST" action="/statis/prasarana/{{$prasarana->id}}/update">
                                    ...
                                    <div class="col-xs-3">
                                        <div class="form-group {{$errors->has('tanggal') ? 'has-error' : ''}} ">
                                            ...
                                            <input name="tanggal" type="date" class="form-control" id="tanggal"
                                                aria-describedby="" placeholder="" value="{{$prasarana->tanggal}}">
                                ...
                                <div class="form-group {{$errors->has('bengkok_kering') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="bengkok_kering" type="text" class="form-control" id="bengkok_kering"
                                        aria-describedby="" placeholder="Ha" value="{{$prasarana->bengkok_kering}}">
                                ...
                                <div class="form-group {{$errors->has('bengkok_tambak') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="bengkok_tambak" type="text" class="form-control" id="bengkok_tambak"
                                        aria-describedby="" placeholder="Ha" value="{{$prasarana->bengkok_tambak}}">
