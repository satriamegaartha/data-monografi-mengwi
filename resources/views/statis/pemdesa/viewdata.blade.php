                                ...
                                <fieldset disabled>
                                    ...
                                    <div class="form-group {{$errors->has('desa') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="desa" type="text" class="form-control" id="desa"
                                            aria-describedby="" placeholder="Buah" value="{{$pemdesa->desa}}">
                                        @if ($errors->has('desa'))
                                    ...
                                    <div class="form-group {{$errors->has('dusun') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="dusun" type="text" class="form-control" id="dusun"
                                            aria-describedby="" placeholder="Buah" value="{{$pemdesa->dusun}}">
                                        @if ($errors->has('dusun'))
                                    ...
                                    <div class="form-group {{$errors->has('desa_swasembada') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="desa_swasembada" type="text" class="form-control"
                                            id="desa_swasembada" aria-describedby="" placeholder="Buah"
                                            value="{{$pemdesa->desa_swasembada}}">
                                    ...
                                    <div class="form-group {{$errors->has('pembina_kpd_kec') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="pembina_kpd_kec" type="text" class="form-control"
                                            id="pembina_kpd_kec" aria-describedby="" placeholder=""
                                            value="{{$pemdesa->pembina_kpd_kec}}">
