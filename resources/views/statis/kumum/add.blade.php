                ...
                <div class="col-md-12"> 
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Tambah Data Keterangan Umum</h3>
                        </div>
                        <div class="panel-body">                                                        
                            <form method="POST" action="/statis/kumum/create">
                                @csrf                                                                                  
                                <div class="row">
                                    <div class="col-xs-3">
                                ...
                                {{-- <div class="container">
                                    <div class="input-group date">
                                        <input type="text" class="form-control" id="datepicker" placeholder="DD/MM/YYYY" name="tanggal">
                                    </div>
                                  </div> --}}
                                
                                <div class="form-group {{$errors->has('tinggi_pusat') ? 'has-error' : ''}} ">
                                    <label for="tinggi_pusat">1.1. Tinggi Pusat Pemerintahan Wilayah Kecamatan dari permukaan laut (M.DPL)</label>
                                    <input name="tinggi_pusat" type="text" class="form-control" id="tinggi_pusat" aria-describedby="" placeholder="M.DPL" value="{{old('tinggi_pusat')}}">
                                ...
                                <div class="form-group {{$errors->has('suhu_max_min') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="suhu_max_min" type="text" class="form-control" id="suhu_max_min" aria-describedby="" placeholder="c" value="{{old('suhu_max_min')}}">
                                ...
                                <div class="form-group {{$errors->has('jpp_desa') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="jpp_desa" type="text" class="form-control" id="jpp_desa" aria-describedby="" placeholder="Km / Jam" value="{{old('jpp_desa')}}">
                                ...
                                <div class="form-group {{$errors->has('jpp_kabupaten') ? 'has-error' : ''}} ">                                    
                                    ...
                                    <input name="jpp_kabupaten" type="text" class="form-control" id="jpp_kabupaten" aria-describedby="" placeholder="Km / Jam" value="{{old('jpp_kabupaten')}}">
                                ...
                                <div class="form-group {{$errors->has('jpp_propinsi') ? 'has-error' : ''}} ">                                    
                                    <label for="jpp_propinsi">c. Ibukota Propinsi (Km / Jam)</label>
                                    <input name="jpp_propinsi" type="text" class="form-control" id="jpp_propinsi" aria-describedby="" placeholder="Km / Jam" value="{{old('jpp_propinsi')}}">
                                ...
                                <div class="form-group {{$errors->has('ch_jumlah_hari') ? 'has-error' : ''}} ">
                                    ...
                                    <br>
                                    <label for="ch_jumlah_hari">a. Jumlah hari dengan curah hujan yang terbanyak (Hari)</label>
                                    <input name="ch_jumlah_hari" type="text" class="form-control" id="ch_jumlah_hari" aria-describedby="" placeholder="Hari" value="{{old('ch_jumlah_hari')}}">
                                ...
                                <div class="form-group {{$errors->has('ch_banyaknya') ? 'has-error' : ''}} ">                                    
                                    ...
                                    <input name="ch_banyaknya" type="text" class="form-control" id="ch_banyaknya" aria-describedby="" placeholder="mm/thn" value="{{old('ch_banyaknya')}}">
                                ...
                                <div class="form-group {{$errors->has('bw_data_berombak') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="bw_data_berombak" type="text" class="form-control" id="bw_data_berombak" aria-describedby="" placeholder="%" value="{{old('bw_data_berombak')}}">
                                ...
                                <div class="form-group {{$errors->has('bw_berombak_berbukit') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="bw_berombak_berbukit" type="text" class="form-control" id="bw_berombak_berbukit" aria-describedby="" placeholder="%" value="{{old('bw_berombak_berbukit')}}">
                                ...
                                <div class="form-group {{$errors->has('bw_berbukit_bergunung') ? 'has-error' : ''}} ">
                                    ...
                                    <input name="bw_berbukit_bergunung" type="text" class="form-control" id="bw_berbukit_bergunung" aria-describedby="" placeholder="%" value="{{old('bw_berbukit_bergunung')}}">
