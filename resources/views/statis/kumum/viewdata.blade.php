                                ...
                                <fieldset disabled>
                                    ...
                                    <div class="form-group {{$errors->has('ch_jumlah_hari') ? 'has-error' : ''}} ">
                                        ...
                                        <label for="ch_jumlah_hari">a. Jumlah hari dengan curah hujan yang terbanyak
                                            (Hari)</label>
                                        <input name="ch_jumlah_hari" type="text" class="form-control"
                                            id="ch_jumlah_hari" aria-describedby="" placeholder=""
                                            value="{{$kumum->ch_jumlah_hari}}">
                                    ...
                                    <div
                                        class="form-group {{$errors->has('bw_berombak_berbukit') ? 'has-error' : ''}} ">
                                    ...
                                    <div
                                        class="form-group {{$errors->has('bw_berbukit_bergunung') ? 'has-error' : ''}} ">
