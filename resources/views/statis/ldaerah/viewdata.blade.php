                            ...
                            <form method="POST" action="/statis/ldaerah/create">
                                <fieldset disabled>
                                    ...
                                    <div class="form-group {{$errors->has('ts_tadah_hujan') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="ts_tadah_hujan" type="text" class="form-control"
                                            id="ts_tadah_hujan" aria-describedby="" placeholder="Ha"
                                            value="{{$ldaerah->ts_tadah_hujan}}">
                                    ...
                                    <div class="form-group {{$errors->has('tu_jalur_hijau') ? 'has-error' : ''}} ">
                                        ...
                                        <input name="tu_jalur_hijau" type="text" class="form-control"
                                            id="tu_jalur_hijau" aria-describedby="" placeholder="Ha"
                                            value="{{$ldaerah->tu_jalur_hijau}}">
                                    ...
                                    <div class="form-group {{$errors->has('tanah_lain_lain') ? 'has-error' : ''}} ">
                                        <label for="tanah_lain_lain">2.7. Lain-lain (tanah tandus, tanah pasir)
                                            (Ha)</label>
                                        <input name="tanah_lain_lain" type="text" class="form-control"
                                            id="tanah_lain_lain" aria-describedby="" placeholder="Ha"
                                            value="{{$ldaerah->tanah_lain_lain}}">
