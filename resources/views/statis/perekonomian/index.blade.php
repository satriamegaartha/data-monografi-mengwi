                                    ...
                                    <table class="table table-hover" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">{{$i++}}</th>
                                                <td><a
                                                        href="/statis/perekonomian/{{$p->id}}/viewdata">{{date_format(date_create($p->tanggal),"d F Y")}}</a>
                                                </td>
                                                <td><a
                                                        href="/statis/perekonomian/{{$p->id}}/viewdata">{{$p->semester}}</a>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="/statis/perekonomian/{{$p->id}}/delete"
